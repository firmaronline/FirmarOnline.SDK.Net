...
namespace FirmarOnline.Samples.ConsoleClient.PSC
{
    ...
    {
        /// <summary>
        /// Ejemplo de llamada a la API para obtener la información del error producido en el procesamiento del sobre.
        /// </summary>
        /// <remarks>Requiere de un identificador de sobre.</remarks>
        public static async Task GetDocumentSetErrorInfoAsync()
        {
            ...
            // Llamada a la API 
            var result = await client.GetDocumentSetErrorInfoAsync(documentSetId);
