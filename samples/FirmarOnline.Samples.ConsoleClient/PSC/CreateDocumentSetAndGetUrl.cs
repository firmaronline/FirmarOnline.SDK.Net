...
{
    /// <summary>
    /// Creación de un sobre simple con un único destinatario y un único documento y obtención de la URL del sobre.
    /// </summary>
    internal static partial class CreateDocumentSetSamples
    {
        ...
        /// recuperando la url para acceder al visor de firma.
        /// </summary>
        public static async Task CreateDocumentSetAndGetUrl()
        {
            ...
            var documentSet = new SimpleDocumentSet
            {
            ...
            var createdDocumentSet = await client.PostDocumentSetAndGetUrlAsync(documentSet);
